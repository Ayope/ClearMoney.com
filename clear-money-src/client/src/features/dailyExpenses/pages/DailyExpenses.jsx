          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {filteredDailyExpenses.map((dailyExpense, index) => (
                    <React.Fragment key={dailyExpense.id}>
                      {index === 0 ||
                      new Date(
                        filteredDailyExpenses[index - 1].date
                      ).toDateString() !==
                        new Date(dailyExpense.date).toDateString() ? (
                        <tr>
                          <td
                            colSpan="6"
                            className="bg-gray-100 dark:bg-gray-800 px-4 py-2 font-semibold"
                          >
                            ...
                            >
                              ...
                              <li>
                                <button
                                  ...
                                  onClick={() =>
                                    handlePreviewClick(dailyExpense)
                                  }
                                  className="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200"
                                >
                                  <svg
                              ...
                              <li>
                                <button
                                  ...
                                  onClick={() =>
                                    handleDeleteClick(dailyExpense)
                                  }
                                >
                                  <svg
                                    className="w-4 h-4 mr-2"
